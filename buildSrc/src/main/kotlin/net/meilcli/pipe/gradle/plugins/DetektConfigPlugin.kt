...
import net.meilcli.pipe.gradle.dependencies.Dependencies
import net.meilcli.pipe.gradle.dependencies.Detekt
import net.meilcli.pipe.gradle.dependencies.MobileAct
import net.meilcli.pipe.gradle.extensions.detektPlugins
...
class DetektConfigPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        project.extensions.findByType(DetektExtension::class.java)?.apply {
            ...
            reports.apply {
                xml.enabled = true
                val name = project.projectDir.toRelativeString(project.rootProject.rootDir)
                    .replace("/", "_")
