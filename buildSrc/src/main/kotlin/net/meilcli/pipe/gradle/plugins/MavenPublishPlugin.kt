...
class MavenPublishPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        extension.repositories {
            maven {
                name = "GitHubPackages"
                url = URI("https://maven.pkg.github.com/MeilCli/recyclerview-pipe")
        ...
        project.afterEvaluate {
            ...
            extension.publications {
                ...
                val attach: (MavenPublication) -> Unit = {
                    it.groupId = "net.meilcli.pipe"
                    it.version = versionValue

                    it.pom {
                        name.set("Librarian")
                        url.set("https://github.com/MeilCli/recyclerview-pipe")
                        licenses {
                            license {
                                name.set("MIT License")
                                url.set("https://github.com/MeilCli/recyclerview-pipe/blob/master/LICENSE")
                            }
                        }
                        developers {
                            developer {
            ...
            bintray.apply {
                user =
                    project.findProperty("bintray.user") as? String ?: System.getenv("BINTRAY_USER")
                key = project.findProperty("bintray.token") as? String
                    ?: System.getenv("BINTRAY_TOKEN")
                pkg.apply {
                    userOrg = "meilcli"
                    repo = "recyclerview-pipe"
                    name = project.name
                    setLicenses("MIT")
                    githubRepo = "MeilCli/recyclerview-pipe"
                    websiteUrl = "https://github.com/MeilCli/recyclerview-pipe"
                    vcsUrl = "https://github.com/MeilCli/recyclerview-pipe.git"
